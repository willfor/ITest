...
import jws.Invoker.InvocationContext;
import jws.classloading.enhancers.ControllersEnhancer.ControllerInstrumentation;
import jws.mvc.ActionInvoker;
import jws.mvc.Http;
import jws.mvc.Http.Request;
import jws.mvc.Http.Response;
import jws.mvc.Scope.RenderArgs;
import jws.Invoker;
import jws.mvc.Controller;
import jws.mvc.Router.ActionDefinition;
import jws.test.TestEngine;

public class JTestBaseWithRequest {
    
    @Rule
    public JwsRunner.StartJws startJwsBeforeTests = JwsRunner.StartJws.rule(true);
    ...
    public static Response POST(Request request, Object url,
        ...
        return POST(request, url, contenttype,
     ...
     * @return the response
     */
    public static Response PUT(Request request, Object url, String contenttype,
            String body) {
        String path = "";
        String queryString = "";
        String turl = url.toString();
    ...
    public static void makeRequest(final Request request,
                ...
                .submit(new Invoker.Invocation() {
                    ...
                    public InvocationContext getInvocationContext() {
                        ...
                        return new InvocationContext(Http.invocationType,
                                ...
                                request.invokedMethod.getDeclaringClass()
                                        .getAnnotations());
                    }
    ...
    public static Request newRequest() {
        Request request = jws.mvc.Http.Request.createRequest(null, "GET", "/", "", null, null, null, null, false, 80, "localhost", false, null, null, null);
        return request;
    }
    ...
    public static void assertStatus(int status, Response response) {
        org.junit.Assert.assertEquals("Response status ", (Object) status,
                response.status);
    }
    ...
    public static void assertContentEquals(String content, Response response) {
        org.junit.Assert.assertEquals(content, getContent(response));
    }
    ...
    public static void assertContentMatch(String pattern, Response response) {
        ...
        org.junit.Assert.assertTrue("Response content does not match '"
                + pattern + "'", ok);
    }
    ...
    public static void assertCharset(String charset, Response response) {
        ...
        String responseCharset = (pos > 7) ? response.contentType
                .substring(pos).toLowerCase() : "";
        org.junit.Assert.assertEquals("Response charset",
                charset.toLowerCase(), responseCharset);
    }
    ...
    public static void assertContentType(String contentType, Response response) {
        org.junit.Assert.assertTrue("Response contentType unmatched : '"
     ...
     *            server response
     */
    public static void assertHeaderEquals(String headerName, String value,
            Response response) {
        org.junit.Assert.assertNotNull("Response header " + headerName
                + " missing", response.headers.get(headerName));
        org.junit.Assert.assertEquals("Response header " + headerName
                + " mismatch", value, response.headers.get(headerName).value());
    }
