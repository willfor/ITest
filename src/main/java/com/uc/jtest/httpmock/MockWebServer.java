...
import static com.uc.jtest.httpmock.SocketPolicy.DISCONNECT_AT_START;
import static com.uc.jtest.httpmock.SocketPolicy.FAIL_HANDSHAKE;
...
import com.uc.jtest.utils.PrintUtil;
    ...
    public final class MockWebServer {
        ...
        public URL getIpUrl(String path) {
            try {
                return sslSocketFactory != null
                        ? new URL("https://" + getLocalIpAddress() + ":" + getPort() + path)
                        : new URL("http://" + getLocalIpAddress() + ":" + getPort() + path);
            } catch (MalformedURLException e) {
                throw new AssertionError(e);
            }
        }
        
        public URL getLocalIpUrl(String path) {
            try {
                return sslSocketFactory != null
                        ? new URL("https://127.0.0.1:" + getPort() + path)
                        : new URL("http://127.0.0.1:" + getPort() + path);
            } catch (MalformedURLException e) {
                throw new AssertionError(e);
            }
        }
        ...
        /**
         * 
         * @return the real ipv4 address of the device
         */
                ...
                for (Enumeration<NetworkInterface> en = NetworkInterface.getNetworkInterfaces(); en.hasMoreElements();) {
                    ...
                    for (Enumeration<InetAddress> enumIpAddr = intf.getInetAddresses(); enumIpAddr.hasMoreElements();) {
                        ...
                        if (!inetAddress.isLoopbackAddress() && inetAddress instanceof Inet4Address) {
                        	PrintUtil.print("hostaddress" + inetAddress.getHostAddress(),Level.INFO);
        ...
        /**
         *  return the total numbers of opened socket
         * @return
         */
        
        public int getOpenSocketsNum(){
        	return openClientSockets.size();
        }
        ...
        public void enqueue(MockResponse response,String type) {
            ((QueueDispatcher) dispatcher).enqueueResponse(response.clone(),type);
        }
        
        public void setfaviconSocketPolicyDisconnect(boolean SocketPolicyDisconnect){
        	((QueueDispatcher) dispatcher).setfaviconSocketPolicyDisconnect(SocketPolicyDisconnect);
        }
        ...
        public void play(int port) throws IOException {
            ...
            //InetAddress ipadr = InetAddress.getByName(getLocalIpAddress());
            ...
            //serverSocket = new ServerSocket(port,0,ipadr);
